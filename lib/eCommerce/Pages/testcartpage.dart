...
class testCartPage extends StatefulWidget {
  //final List<Map<String, dynamic>> cartItems;
  int itemslength;

  testCartPage({super.key, required this.itemslength});

  @override
  _testCartPageState createState() => _testCartPageState();
}

class _testCartPageState extends State<testCartPage> {
  ...
  void calculateTotalPrice() {
    ...
    for (int i = 0; i < items_count.length; i++) {
      num price = num.parse(value.lst[i].price);
